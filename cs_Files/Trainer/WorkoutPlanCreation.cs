...
{
    public partial class WorkoutPlanCreation : Form
    {
        int TrainerID;
        public WorkoutPlanCreation(int Tid = 0)
        {
            InitializeComponent();
            TrainerID = Tid;
            this.WorkoutPlanCreation_Load();
        }
        ...
        private void WorkoutPlanCreation_Load()
        {
        ...
        //returns its id from Exercise_sets_rep so that we can insert it in workoutplan_exercise_table
        ...
        private void WorkoutPlanCreation_Load(object sender, EventArgs e)
        {
